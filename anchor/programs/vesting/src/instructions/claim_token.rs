...
use anchor_spl::{associated_token::AssociatedToken,token_interface::{transfer_checked, TokenAccount, TokenInterface, Mint, TransferChecked}};
...
pub fn process_claim_token(ctx: Context<ClaimToken>, _company_name: String) -> Result<()> {
